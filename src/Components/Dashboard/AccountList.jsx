                ...
                {accountsList?.map((acc) => {
                  return (
                    <div key={acc?._id} className="group block mb-6" to="#">
                      <div className="flex items-center justify-between flex-wrap p-10 bg-coolGray-50 group-hover:bg-gray-300 rounded-md shadow-md transition duration-200">
                          ...
                          <div className="w-full md:w-1/2 md:text-right">
                            <div className="inline-flex items-center leading-6 text-green-500 group-hover:text-green-600 font-medium transition duration-200">
                              ...
                              <svg
                                ...
                                viewBox="0 0 20 20"
                                fill="none"
                                xmlns="http://scwww.w3.org/2000/svg"
                              >
                                <path
